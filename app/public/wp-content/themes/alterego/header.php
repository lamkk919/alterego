...
<div id="page" class="site">
	...
	<!-- here we grab the custom field from our category and display the color an inline style -->
	<header id="masthead" class="site-header flex" style="<?php category_header_background(); ?>">
		...
		<!-- here we have a link with out logo that goes back to the homepage -->
		...
		<div class="site-branding">
			<!-- our feature image will go in here -->
			<?php echo wp_get_attachment_image(49, 'full'); ?>
		</div><!-- .site-branding -->
